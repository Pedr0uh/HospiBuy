...
CREATE SCHEMA IF NOT EXISTS HospiBuy;
USE HospiBuy;
...
----------------------------------------------------------------------------------------------------------------------------------
-- Ultilizar esses dois código juntos antes para fazer com que o auto_increment da tabela operaçoes começe com 1 e evitar erro ❗
----------------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO fornecedor (nome, tipo, cnpj, cpf, email, telefone, endereco) VALUES
...
INSERT INTO movimentacao (sku, quantidade, id_operacao, data_mov, status) VALUES
